...
public class OreSpawnTeleporter extends Teleporter
{
    ...
    public boolean justPutMe(final Entity par1Entity) {
        ...
        if (par1Entity instanceof EntityPlayer) {
            ...
            final List<Entity> var5 = this.oldWorld.getEntitiesWithinAABB((Class)EntityTameable.class, bb);
            for (final Entity var7 : var5) {
                ...
                if (!et.isSitting()) {
                    ...
                    this.sendToThisDimension(var7, newX, newY, newZ, (int)ep.rotationYaw);
                }
            }
        }
