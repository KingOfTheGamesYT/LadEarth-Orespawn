    ...
    public void populate(final IChunkProvider par1IChunkProvider, final int par2, final int par3) {
        ...
        for (doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, PopulateChunkEvent.Populate.EventType.ICE), k2 = 0; doGen && k2 < 16; ++k2) {
            for (int l21 = 0; l21 < 16; ++l21) {
                i2 = this.worldObj.getPrecipitationHeight(k + k2, l + l21);
                if (this.worldObj.isBlockFreezable(k2 + k, i2 - 1, l21 + l)) {
                    this.worldObj.setBlock(k2 + k, i2 - 1, l21 + l, Blocks.ice, 0, 2);
                }
                if (this.worldObj.func_147478_e(k2 + k, i2, l21 + l, true)) {
                    this.worldObj.setBlock(k2 + k, i2, l21 + l, Blocks.snow_layer, 0, 2);
                }
            }
        }
        ...
        if (var5 != null) {
            ...
            if (par1EnumCreatureType == EnumCreatureType.monster) {
                if (this.MyMobList == null) {
                    ...
                    for (final BiomeGenBase.SpawnListEntry var7 : l) {
